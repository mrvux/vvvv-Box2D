...
namespace VVVV 
{
	namespace Nodes 
	{
		...
		void Box2dBaseControllerDefNode::SetPluginHost(IPluginHost^ Host)
		{
			...
			this->FHost->CreateValueInput("Clear",1,nullptr,TSliceMode::Dynamic,TPinVisibility::True,this->vInClear);
			...
			//this->FHost->CreateValueOutput("Body Count",1,nullptr,TSliceMode::Dynamic,TPinVisibility::True,this->vOutBodyCount);
