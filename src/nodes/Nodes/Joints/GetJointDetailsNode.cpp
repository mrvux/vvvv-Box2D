...
namespace VVVV 
{
	namespace Nodes 
	{
		...
		void GetJointDetailsNode::SetPluginHost(IPluginHost^ Host) 
		{
			...
			this->FHost->CreateValueOutput("Anchor 1",2,nullptr,TSliceMode::Dynamic,TPinVisibility::True,this->vOutPosition1);
			...
			this->FHost->CreateValueOutput("Anchor 2",2,nullptr,TSliceMode::Dynamic,TPinVisibility::True,this->vOutPosition2);
			this->vOutPosition2->SetSubType2D(Double::MinValue,Double::MaxValue,0.01,0.0,0.0,false,false,false);

			//this->FHost->CreateValueOutput("Force",2,nullptr,TSliceMode::Dynamic,TPinVisibility::True,this->vOutPosition1);
			//this->vOutPosition1->SetSubType2D(Double::MinValue,Double::MaxValue,0.01,0.0,0.0,false,false,false);
